                  ...
                  <div class="card">
                    <div class="rounded-top text-white d-flex flex-row" style="background-color: #000; height:200px;">
                      <div class="ml-4 mt-5 d-flex flex-column" style="width: 150px; height: 280px;">
                        <img src=<?php echo $row['avatar'] ? ($row['type'] == 'SUPPLIER' ? "../supplier/uploads/".$row['avatar'] : "uploads/".$row['avatar']) : '../../img/undraw_profile.svg' ?> alt="Generic placeholder image" class="img-fluid img-thumbnail mt-4 mb-2" style="width: 150px; height: 150px; z-index: 1">
                      </div>
