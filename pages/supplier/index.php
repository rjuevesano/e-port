<?php
  ...
  $sql = "select a.*, b.* from post as a inner join user as b on a.user_id=b.user_id where b.type!='SUPPLIER' and a.status='PUBLISHED' order by a.created desc";
          ...
          <div class="card shadow m-3">
            ...
            <div class="card-body">
              ...
              <div class="grid mb-3">
                ...
                ?>
                  <a data-fslightbox="gallery<?php echo $post_id ?>" href="<?php echo $path.$row_image['path'] ?>">
                    <img src="<?php echo $path.$row_image['path'] ?>" alt=""/>
                  </a>
                <?php
                    }}
                  }
